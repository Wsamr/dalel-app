import 'package:dalel_app/core/constant/reg_expre_form.dart';

abstract class Validator {
  static String? validateEmail(String? val) {
    final RegExp emailRegex = RegExp(RegExpreForm.emailRegex);
  ...
  static String? validatePassword(String? val) {
    final RegExp passwordRegex = RegExp(RegExpreForm.passwordRegex);
